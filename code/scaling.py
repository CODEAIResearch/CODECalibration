...
class UCEModelWithTemperature(nn.Module):
    ...
    def set_temperature(self ):
        ...
        before_temperature_uce = uce_criterion(self.eval_values, 1-self.eval_correctness).item()
        ...
        def eval():
            ...
            loss = uce_criterion(scaled_uncertainties, 1-self.eval_correctness)
            loss.backward()
            return loss
        ...
        after_temperature_uce = uce_criterion(self.temperature_scale(self.eval_values), 1-self.eval_correctness).item()
...
class ECEModelWithTemperature(nn.Module):
    ...
    def temperature_scale(self, confidences):
        ...
        """
        return confidences ** (1 / self.temperature)  # Scaling transformation
