...
def calculate_scores(answers,predictions):
    ...
    scores={}
    scores['Acc']=np.mean(Acc)
    scores['Recall']=recall_score(y_trues, y_preds, average='weighted')
    scores['Precision']=precision_score(y_trues, y_preds, average='weighted')
    scores['F1']=f1_score(y_trues, y_preds, average='weighted')
    return scores
